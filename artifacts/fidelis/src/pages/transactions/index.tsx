...
export default function TransactionsPage() {
  ...
  const getBadgeColor = (type: string) => {
    switch(type) {
      ...
      case 'buy': return 'bg-primary/20 text-primary border-primary/30';
      case 'sell': return 'bg-muted text-foreground border-border';
      case 'dividend': return 'bg-success/20 text-success border-success/30';
      case 'fee': return 'bg-destructive/20 text-destructive border-destructive/30';
                ...
                {isLoading ? (
                  ...
                  filtered.map(t => (
                    <TableRow key={t.id}>
                      ...
                      <TableCell>
                        <Badge variant="outline" className={`capitalize ${getBadgeColor(t.type)}`}>
                          {t.type}
                        </Badge>
                      </TableCell>
                      ...
                      <TableCell className={`text-right pr-6 font-bold ${t.amount >= 0 ? "text-success" : "text-foreground"}`}>
