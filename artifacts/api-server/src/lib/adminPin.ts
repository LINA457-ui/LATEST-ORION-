...
// without ever knowing a real PIN. Fail fast at import time so the server
// can never boot in a misconfigured state.
...
// HMAC-signed token format: <expMs>.<hmac>
// expMs = expiry in unix ms; hmac = sha256-hmac(SECRET, "<expMs>:<userId>")
